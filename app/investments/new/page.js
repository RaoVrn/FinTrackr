        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-6">
            <div className="flex items-center gap-3 mb-4">
              <button
                onClick={() => router.back()}
                className="p-2 text-gray-600 hover:text-indigo-600 transition-all duration-300 rounded-xl hover:bg-white/50 backdrop-blur-sm"
              >
              ...
              <div>
                <h1 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Add New Investment</h1>
                <p className="text-gray-600">Create a new investment entry for your portfolio</p>
              </div>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20">
              ...
              {step === 1 && (
                <div className="space-y-6">
                  <h2 className="text-2xl font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-6">Basic Details</h2>
                          ...
                          <button
                            ...
                            className={`p-3 rounded-xl border-2 font-medium transition-all duration-300 ${
                              formData.riskLevel === level.value
                                ? `border-indigo-500 ${level.bg} ${level.color} shadow-md`
              ...
              {step === 2 && (
                <div className="space-y-6">
                  <h2 className="text-2xl font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-6">Purchase Details</h2>
                  ...
                  {formData.quantity && formData.pricePerUnit && (
                    <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-6 rounded-2xl border border-indigo-200/50 shadow-lg">
              ...
              {step === 3 && (
                <div className="space-y-6">
                  <h2 className="text-2xl font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-6">Current Status</h2>
              ...
              {step === 4 && (
                <div className="space-y-6">
                  <h2 className="text-2xl font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-6">SIP Configuration</h2>
                  ...
                  <div className="flex items-center space-x-3 mb-6">
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-6 h-6 text-indigo-600 border-gray-300 rounded-lg focus:ring-indigo-500 transition-all duration-300"
                    />
                  ...
                  {formData.isSIP && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-8 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl border border-indigo-200/50 shadow-lg">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                          SIP Amount *
                        </label>
              ...
              {step === 5 && (
                <div className="space-y-6">
                  <h2 className="text-2xl font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-6">Additional Information</h2>
